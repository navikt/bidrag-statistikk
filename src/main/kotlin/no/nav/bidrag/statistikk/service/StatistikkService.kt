...
/*        val vedtakSkalBehandles = vedtakHendelse.id in setOf(
            130221, 130222, 130223, 130224, 131012, 131011, 131012, 131132, 162374, 165952, 404037, 417293, 444607, 999999999)
    ...
    private fun finnGrunnlagsdataBidrag(
        ...
        val respons = if (vedtakFraBisys) {
            GrunnlagsdataBidrag(
                ...
                bPsAndelUnderholdskostnad = null,
                nettoTilsynsutgift = null,
                faktiskUtgift = null,
                samværsfradrag = null,
                nettoBarnetilleggBP = null,
                nettoBarnetilleggBM = null,
                bPBorMedAndreVoksne = null,
                samværsklasse = null,
                bPInntektListe = null,
                bMInntektListe = null,
            )
            ...
            GrunnlagsdataBidrag(
                ...
                bPsAndelUnderholdskostnad = grunnlagListe.finnBpsAndelUnderholdskostnadForPeriode(
                    vedtakErAldersjustering,
                    vedtakFraBisys,
