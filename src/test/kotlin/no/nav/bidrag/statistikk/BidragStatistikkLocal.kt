...
@ComponentScan(excludeFilters = [ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = [BidragStatistikk::class, BidragStatistikkTest::class])])
class BidragStatistikkLocal {
    companion object {
...
fun main(args: Array<String>) {
    ...
    val app = SpringApplication(BidragStatistikkLocal::class.java)
